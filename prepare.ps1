# This script prepares all the required .targets file, header files and binary
# files for the NuGet package.
...
foreach ($header in $headers)
{
    if ($header -eq '${CMAKE_BINARY_DIR}/taglib_config.h') {
        # Skip it. taglib_config.h will be generated by CMake.
    }
    else {
...
# Will be removed in TagLib2.0. Because C4251 is already fixed in TagLib2.0.
